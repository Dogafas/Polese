...
class TicketAdminForm(forms.ModelForm):
    ...
    def clean(self):
        ...
        if voyage and departure_stop and arrival_stop:
            ...
            try:
                departure_route_point = RoutePoint.objects.get(route=voyage.route, stop=departure_stop)
            ...
            try:
                arrival_route_point = RoutePoint.objects.get(route=voyage.route, stop=arrival_stop)
            except RoutePoint.DoesNotExist:
