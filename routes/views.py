...
def schedule_view(request):
    ...
    for route in routes:
        ...
        departure_location = route_points.first().stop.name if route_points.exists() else None
        arrival_location = route_points.last().stop.name if route_points.exists() else None
