...
class VoyageStopPrice(models.Model):
    voyage_stop_price_id = models.AutoField(primary_key=True, verbose_name="ID стоимости рейса до остановки")
    voyage = models.ForeignKey(Voyage, on_delete=models.CASCADE, verbose_name="Рейс")
    stop = models.ForeignKey(Stop, on_delete=models.CASCADE, verbose_name="Остановочный пункт")
